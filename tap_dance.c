...
void dance_esc_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[0].step) {
        case SINGLE_TAP: register_code16(ES_MORD); break;
        case SINGLE_HOLD: register_code16(KC_ESCAPE); break;
        case DOUBLE_TAP: register_code16(ES_MORD); register_code16(ES_MORD); break;
        case DOUBLE_SINGLE_TAP: tap_code16(ES_MORD); register_code16(ES_MORD);
    }
}
...
void dance_esc_reset(qk_tap_dance_state_t *state, void *user_data) {
    wait_ms(10);
    switch (dance_state[0].step) {
        case SINGLE_TAP: unregister_code16(ES_MORD); break;
        case SINGLE_HOLD: unregister_code16(KC_ESCAPE); break;
        case DOUBLE_TAP: unregister_code16(ES_MORD); break;
        case DOUBLE_SINGLE_TAP: unregister_code16(ES_MORD); break;
    }
...
void dance_n_colmk_finished(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[0].step) {
        ...
        case SINGLE_HOLD: register_code16(S(KC_N)); break;
        case DOUBLE_TAP: register_code16(ES_NTIL); break;
        case DOUBLE_HOLD: register_code16(S(ES_NTIL)); break;
...
void dance_n_colmk_reset(qk_tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[0].step) {
        ...
        case DOUBLE_TAP: unregister_code16(ES_NTIL);unregister_code16(ES_NTIL); break;
        case DOUBLE_HOLD: unregister_code16(ES_NTIL);unregister_code16(ES_NTIL); break;
        case DOUBLE_SINGLE_TAP: unregister_code16(KC_N);unregister_code16(KC_N); break;
    }
    dance_state[0].step = 0;
}
...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_4] = ACTION_TAP_DANCE_FN_ADVANCED(on_dance_4, dance_4_finished, dance_4_reset),
    [TD_5] = ACTION_TAP_DANCE_FN_ADVANCED(on_dance_5, dance_5_finished, dance_5_reset),
    [TD_6] = ACTION_TAP_DANCE_FN_ADVANCED(on_dance_6, dance_6_finished, dance_6_reset),
    [TD_7] = ACTION_TAP_DANCE_FN_ADVANCED(on_dance_7, dance_7_finished, dance_7_reset),
